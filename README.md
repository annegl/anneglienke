...
- `challenge`: prefix to identify non-confidential coding challenges I worked on. I only post the ones that were approved but they're not necessarily from companies I joined.
